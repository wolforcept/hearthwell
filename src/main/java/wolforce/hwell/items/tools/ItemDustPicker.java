...
public class ItemDustPicker extends ItemTool {
	...
	public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand,
		...
		if (worldIn.getBlockState(pos).getBlock() instanceof BlockPickerHolder && player.isSneaking()
				&& hand == EnumHand.MAIN_HAND)
			worldIn.getBlockState(pos).getBlock().onBlockActivated(worldIn, pos, worldIn.getBlockState(pos), player,
