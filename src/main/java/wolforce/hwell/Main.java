...
import wolforce.hwell.base.MyLog;
import wolforce.hwell.blocks.BlockAntiGravity;
import wolforce.hwell.blocks.BlockBox;
import wolforce.hwell.blocks.BlockBoxer;
import wolforce.hwell.blocks.BlockBranch;
import wolforce.hwell.blocks.BlockBurstSeed;
import wolforce.hwell.blocks.BlockCharger;
import wolforce.hwell.blocks.BlockCore;
import wolforce.hwell.blocks.BlockCrushing;
import wolforce.hwell.blocks.BlockFertileSoil;
import wolforce.hwell.blocks.BlockFormer;
import wolforce.hwell.blocks.BlockFreezer;
import wolforce.hwell.blocks.BlockGaseous;
import wolforce.hwell.blocks.BlockGaseousFrame;
import wolforce.hwell.blocks.BlockGraftingTray;
import wolforce.hwell.blocks.BlockGravity;
import wolforce.hwell.blocks.BlockGravityMini;
import wolforce.hwell.blocks.BlockGritVase;
import wolforce.hwell.blocks.BlockGroundShovel;
import wolforce.hwell.blocks.BlockHeat;
import wolforce.hwell.blocks.BlockHeatFurnace;
import wolforce.hwell.blocks.BlockInertSeed;
import wolforce.hwell.blocks.BlockLightCollector;
import wolforce.hwell.blocks.BlockMutator;
import wolforce.hwell.blocks.BlockMystBush;
import wolforce.hwell.blocks.BlockMystGrass;
import wolforce.hwell.blocks.BlockMystLeaves;
import wolforce.hwell.blocks.BlockNourisher;
import wolforce.hwell.blocks.BlockPickerHolder;
import wolforce.hwell.blocks.BlockPickingTable;
import wolforce.hwell.blocks.BlockPowerNodeBuilder;
import wolforce.hwell.blocks.BlockPrecisionGrinder;
import wolforce.hwell.blocks.BlockPrecisionGrinderEmpty;
import wolforce.hwell.blocks.BlockProducer;
import wolforce.hwell.blocks.BlockPuller;
import wolforce.hwell.blocks.BlockSeparator;
import wolforce.hwell.blocks.BlockSetter;
import wolforce.hwell.blocks.BlockShardLiquifier;
import wolforce.hwell.blocks.BlockSlabLamp;
import wolforce.hwell.blocks.BlockStoneDust;
import wolforce.hwell.blocks.BlockTray;
...
import wolforce.hwell.items.ItemCrystal;
import wolforce.hwell.items.ItemCrystalBowl;
import wolforce.hwell.items.ItemCrystalBowlWater;
import wolforce.hwell.items.ItemEmptyRod;
import wolforce.hwell.items.ItemGrindingWheel;
import wolforce.hwell.items.ItemHeavyShears;
import wolforce.hwell.items.ItemLockedLight;
import wolforce.hwell.items.ItemLoot;
import wolforce.hwell.items.ItemMystDust;
import wolforce.hwell.items.ItemMystFertilizer;
import wolforce.hwell.items.ItemPowerCrystal;
import wolforce.hwell.items.ItemRawSoulsteel;
import wolforce.hwell.items.ItemRepairingPaste;
import wolforce.hwell.items.ItemSeedOfLife;
import wolforce.hwell.items.ItemShard;
import wolforce.hwell.items.MyFood;
import wolforce.hwell.items.tools.ItemDisplacer;
import wolforce.hwell.items.tools.ItemDustPicker;
import wolforce.hwell.items.tools.MyArmor;
import wolforce.hwell.items.tools.MyAxe;
import wolforce.hwell.items.tools.MyDagger;
import wolforce.hwell.items.tools.MyPickaxe;
import wolforce.hwell.items.tools.MyShovel;
import wolforce.hwell.items.tools.MySword;
...
public class Main {
	...
	public static void preInit(FMLPreInitializationEvent event) {
		...
		quartz_ore = new MyBlock("quar" + "tz_ore", Material.ROCK).setHarvest("pickaxe", 2).setHardness(1)
				.setResistance(2);
