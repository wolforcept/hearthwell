...
import wolforce.hwell.UnjoinableEntityItem;
...
public class BlockBurstSeed extends MyBlock {
	...
	public BlockBurstSeed(Material mat, Block block, String tool, SoundType sound) {
	...
	public void randomTick(World world, BlockPos pos, IBlockState state, Random random) {
		...
		for (int i = 0; i < n; i++) {
			Entity newEntity = new UnjoinableEntityItem(world, pos.getX(), pos.getY(), pos.getZ(),
					new ItemStack(stack.getItem()), 40);
