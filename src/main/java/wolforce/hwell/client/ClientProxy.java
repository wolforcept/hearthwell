...
public class ClientProxy implements wolforce.hwell.Hwell.IProxy {

	@Override
	public void particle(World world, BlockPos pos, BlockPos pos2, Vec3d dir) {
		wolforce.hwell.client.MyParticle particle = wolforce.hwell.client.MyParticle.makeParticle(world, //
