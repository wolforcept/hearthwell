...
public class RecipeGrinding {
	...
	public static void initRecipes() {
		...
		put(new Irio(Blocks.COBBLESTONE), new RecipeGrinding(new ItemStack(Blocks.GRAVEL, 1), iron, diamond));
		put(new Irio(Blocks.GRAVEL), new RecipeGrinding(new ItemStack(Blocks.SAND, 1), iron, diamond));
		put(new Irio(Blocks.LOG, 0), new RecipeGrinding(new ItemStack(Blocks.PLANKS, 6, 0), iron, diamond));
		put(new Irio(Blocks.LOG, 1), new RecipeGrinding(new ItemStack(Blocks.PLANKS, 6, 1), iron, diamond));
		put(new Irio(Blocks.LOG, 2), new RecipeGrinding(new ItemStack(Blocks.PLANKS, 6, 2), iron, diamond));
		put(new Irio(Blocks.LOG, 3), new RecipeGrinding(new ItemStack(Blocks.PLANKS, 6, 3), iron, diamond));
		put(new Irio(Blocks.LOG2, 0), new RecipeGrinding(new ItemStack(Blocks.PLANKS, 6, 4), iron, diamond));
		put(new Irio(Blocks.LOG2, 1), new RecipeGrinding(new ItemStack(Blocks.PLANKS, 6, 5), iron, diamond));
		put(new Irio(Main.myst_log), new RecipeGrinding(new ItemStack(Main.myst_planks, 6), iron, diamond));
		...
		put(new Irio(Items.LEATHER_HELMET), new RecipeGrinding(new ItemStack(Items.LEATHER, 5), iron, diamond));
		put(new Irio(Items.LEATHER_CHESTPLATE), new RecipeGrinding(new ItemStack(Items.LEATHER, 8), iron, diamond));
		put(new Irio(Items.LEATHER_LEGGINGS), new RecipeGrinding(new ItemStack(Items.LEATHER, 7), iron, diamond));
		put(new Irio(Items.LEATHER_BOOTS), new RecipeGrinding(new ItemStack(Items.LEATHER, 4), iron, diamond));

		// DIAMOND ONLY
		put(new Irio(Main.glowstone_ore), new RecipeGrinding(new ItemStack(Items.GLOWSTONE_DUST, 2), diamond));
		put(new Irio(Main.quartz_ore), new RecipeGrinding(new ItemStack(Items.QUARTZ, 2), diamond));
		// iron stuff
		...
		// CRYSTAL
		put(new Irio(Blocks.GLOWSTONE), new RecipeGrinding(new ItemStack(Items.GLOWSTONE_DUST, 4), crystal));
		put(new Irio(Blocks.QUARTZ_BLOCK), new RecipeGrinding(new ItemStack(Items.QUARTZ, 4), crystal));
		put(new Irio(Blocks.BRICK_BLOCK), new RecipeGrinding(new ItemStack(Items.BRICK, 4), crystal));
		put(new Irio(Blocks.PRISMARINE, 0), new RecipeGrinding(new ItemStack(Items.PRISMARINE_SHARD, 4), crystal));
		put(new Irio(Blocks.PRISMARINE, 1), new RecipeGrinding(new ItemStack(Items.PRISMARINE_SHARD, 9), crystal));
		put(new Irio(Blocks.PRISMARINE, 2), new RecipeGrinding(new ItemStack(Items.PRISMARINE_SHARD, 8), crystal));
		put(new Irio(Blocks.WOOL), new RecipeGrinding(new ItemStack(Items.STRING, 4), crystal));
		put(new Irio(Items.WHEAT), new RecipeGrinding(new ItemStack(Main.wheat_flour), crystal));
