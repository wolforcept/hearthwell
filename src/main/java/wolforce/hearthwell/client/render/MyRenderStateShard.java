...
public abstract class MyRenderStateShard {
	...
	public static final MyRenderStateShard.ShaderStateShard BLOCK_SHADER = new MyRenderStateShard.ShaderStateShard(
			GameRenderer::getBlockShader);
	public static final MyRenderStateShard.ShaderStateShard NEW_ENTITY_SHADER = new MyRenderStateShard.ShaderStateShard(
			GameRenderer::getNewEntityShader);
