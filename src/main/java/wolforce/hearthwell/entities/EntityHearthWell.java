...
//				ent.setDefaultPickupDelay();
				level.addParticle(new ParticleEnergyData(0), entPos.x, entPos.y + 0.5, entPos.z, 0, 0, 0);
			}
...
//					int nrOfMystDust = matchesResult[1];
			...
			level.addParticle(new ParticleEnergyData(0), x, y + .75 + random.nextGaussian() * .1, z,
...
//				}
				...
				setHasItems(false);
				((ServerLevel) level).sendParticles(new ParticleEnergyData(0xFF0000), xOld, yOld + 0.66, zOld, 4, //
